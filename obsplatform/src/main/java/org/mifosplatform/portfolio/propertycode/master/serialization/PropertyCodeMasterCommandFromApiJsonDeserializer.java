...
@Component
public class PropertyCodeMasterCommandFromApiJsonDeserializer {

    /**
     * The parameters supported for this command.
     */
    private final Set<String> supportedParameters = new HashSet<String>(Arrays.asList("propertyCodeType","code","description","referenceValue"));
    private final FromJsonHelper fromApiJsonHelper;

    @Autowired
    public PropertyCodeMasterCommandFromApiJsonDeserializer(final FromJsonHelper fromApiJsonHelper) {
