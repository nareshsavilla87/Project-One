...
public class OneTimeSalesApiResource {
	...
	public String retrieveSingleItemDetails(@PathParam("itemId") final Long itemId, @QueryParam("clientId") final Long clientId, 
	    ...
	    ItemData itemData = this.itemMasterReadPlatformService.retrieveSingleItemDetails(clientId, itemId,region,true); // If you pass clientId you can set to 'true' else 'false'
	    if(itemData == null){
