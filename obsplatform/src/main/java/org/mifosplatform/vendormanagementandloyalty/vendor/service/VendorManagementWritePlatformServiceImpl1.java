...
import org.mifosplatform.vendormanagementandloyalty.vendor.serialization.VendorManagementCommandFromApiJsonDeserializer1;
...
@Service
public class VendorManagementWritePlatformServiceImpl1 implements VendorManagementWritePlatformService1{
	
	private static final Logger LOGGER = (Logger) LoggerFactory.getLogger(VendorManagementWritePlatformServiceImpl1.class);	
	
	private PlatformSecurityContext context;
	private VendorRepository vendorRepository; 
	private VendorManagementCommandFromApiJsonDeserializer1 fromApiJsonDeserializer;
	private final FromJsonHelper fromApiJsonHelper;
	private final VendorDetailRepository vendorDetailRepository;
	 
	@Autowired
	public VendorManagementWritePlatformServiceImpl1(final PlatformSecurityContext context, 
			final VendorRepository vendorRepository, 
			final VendorManagementCommandFromApiJsonDeserializer1 fromApiJsonDeserializer,
