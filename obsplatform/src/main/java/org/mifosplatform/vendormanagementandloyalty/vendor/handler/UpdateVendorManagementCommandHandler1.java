...
@Service
public class UpdateVendorManagementCommandHandler1 implements NewCommandSourceHandler {

    private final VendorManagementWritePlatformService1 writePlatformService;

    @Autowired
    public UpdateVendorManagementCommandHandler1(final VendorManagementWritePlatformService1 writePlatformService) {
