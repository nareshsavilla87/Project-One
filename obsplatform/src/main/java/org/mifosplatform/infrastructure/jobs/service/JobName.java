...
public enum JobName {
    ...
    EVENT_ACTION_PROCESSOR("EVENT_ACTIONS"),REPORT_EMAIL("REPORTER"),REPORT_STATMENT("PDF"),RADIUS("RADIUS"),
    EXPORT_DATA("EXPORTDATA"), RESELLER_COMMISSION("RESELLERCOMMISSION"),REPROCESS("REPROCESS");
