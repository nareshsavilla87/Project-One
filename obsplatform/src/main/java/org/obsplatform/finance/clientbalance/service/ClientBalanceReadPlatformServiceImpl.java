...
public class ClientBalanceReadPlatformServiceImpl implements ClientBalanceReadPlatformService {
	...
	@Override
	public ClientBalanceData retrieveBalance(final Long clientid) {
	...
	private static final class BalanceMapper implements RowMapper<ClientBalanceData> {
		...
		@Override
		public ClientBalanceData mapRow(ResultSet rs, int rowNum) throws SQLException {
	...
	public static final class ClientBalanceMapper implements RowMapper<ClientBalanceData> {
