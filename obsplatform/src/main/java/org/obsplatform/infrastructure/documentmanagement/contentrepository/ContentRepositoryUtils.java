 ...
 */
package org.obsplatform.infrastructure.documentmanagement.contentrepository;
...
import org.obsplatform.infrastructure.core.exception.ImageDataURLNotValidException;
import org.obsplatform.infrastructure.core.exception.ImageUploadException;
...
public class ContentRepositoryUtils {
    ...
    public static void validateFileSizeWithinPermissibleRange(final Long fileSize, final String name) {
         ...
         * size is negligible
         **/
        if (fileSize != null && ((fileSize / (1024 * 1024)) > ContentRepository.MAX_FILE_UPLOAD_SIZE_IN_MB)) { throw new DocumentManagementException(
