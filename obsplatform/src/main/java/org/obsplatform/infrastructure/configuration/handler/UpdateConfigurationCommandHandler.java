...
@Service
public class UpdateConfigurationCommandHandler implements NewCommandSourceHandler {

    private final ConfigurationWritePlatformService writePlatformService;

    @Autowired
    public UpdateConfigurationCommandHandler(final ConfigurationWritePlatformService writePlatformService) {
