...
import org.obsplatform.infrastructure.jobs.data.JobDetailDataValidator;
import org.obsplatform.infrastructure.jobs.domain.ScheduledJobDetail;
import org.obsplatform.infrastructure.jobs.domain.ScheduledJobDetailRepository;
import org.obsplatform.infrastructure.jobs.domain.ScheduledJobRunHistory;
import org.obsplatform.infrastructure.jobs.domain.ScheduledJobRunHistoryRepository;
import org.obsplatform.infrastructure.jobs.domain.SchedulerDetail;
import org.obsplatform.infrastructure.jobs.domain.SchedulerDetailRepository;
...
public class SchedularWritePlatformServiceJpaRepositoryImpl implements SchedularWritePlatformService {
    ...
    /**
     * 
     * Please do not change new Date()
     * 
     * */
    if (scheduledJobDetail.isCurrentlyRunning() /** Please do not change new Date() below*/
	...
	@Override
	public CommandProcessingResult updateJobParametersDetail(final Long jobId,final JsonCommand command) {
