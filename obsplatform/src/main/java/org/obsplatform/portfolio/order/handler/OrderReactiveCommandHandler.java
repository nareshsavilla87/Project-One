...
@Service
public class OrderReactiveCommandHandler implements NewCommandSourceHandler {

    private final OrderWritePlatformService writePlatformService;

    @Autowired
    public OrderReactiveCommandHandler(final OrderWritePlatformService writePlatformService) {
