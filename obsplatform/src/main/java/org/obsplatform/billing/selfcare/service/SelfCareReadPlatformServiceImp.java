...
public class SelfCareReadPlatformServiceImp implements SelfCareReadPlatformService {
	...
	public SelfCareData login(String userName, String password) {
		...
		/*if(userName.contains("@")){*/
			...
			sql = "select client_id as clientId, auth_pin as authPin, password as password from b_clientuser where unique_reference=? or username =? and password=? and is_deleted=0";
		/*}else{
