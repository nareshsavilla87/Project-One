...
@Service
public class SelfcareChangePasswordCommandHandler implements NewCommandSourceHandler{

	private final SelfCareWritePlatformService selfCareWritePlatformService; 
	
	@Autowired
	public SelfcareChangePasswordCommandHandler(final SelfCareWritePlatformService selfCareWritePlatformService) {
	...
	public CommandProcessingResult processCommand(JsonCommand command) {
		return selfCareWritePlatformService.selfcareChangePassword(command);
	}
