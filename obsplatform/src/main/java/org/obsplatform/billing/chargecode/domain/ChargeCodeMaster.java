package org.obsplatform.billing.chargecode.domain;
...
public class ChargeCodeMaster extends AbstractPersistable<Long> {
	...
	public ChargeCodeMaster(final String chargeCode, final String chargeDescription,
