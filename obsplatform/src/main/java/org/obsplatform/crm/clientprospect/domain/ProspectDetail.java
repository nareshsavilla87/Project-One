...
public class ProspectDetail extends AbstractAuditableCustom<AppUser, Long> {
	...
	ProspectDetail(final Long prospectId, final String callStatus,
			final Date nextTime, final String notes, final String assignedTo) {
	...
	public static ProspectDetail fromJson(final JsonCommand command,
			final Long prospectId) throws ParseException {
