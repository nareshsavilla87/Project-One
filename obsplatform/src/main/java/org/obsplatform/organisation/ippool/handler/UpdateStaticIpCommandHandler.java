...
@Service
public class UpdateStaticIpCommandHandler implements NewCommandSourceHandler {

	private final IpPoolManagementWritePlatformService ipPoolManagementWritePlatformService;

	@Autowired
	public UpdateStaticIpCommandHandler(
	...
	public CommandProcessingResult processCommand(JsonCommand command) {
		...
		return this.ipPoolManagementWritePlatformService.updateStaticIpStatus(command);
	}
}
