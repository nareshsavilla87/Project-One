...
@Service
public class UpdateIpAddressStatusCommandHandler implements NewCommandSourceHandler {

	
private final IpPoolManagementWritePlatformService ipPoolManagementWritePlatformService;
	
	@Autowired
	public UpdateIpAddressStatusCommandHandler(final IpPoolManagementWritePlatformService ipPoolManagementWritePlatformService) {
	...
	public CommandProcessingResult processCommand(JsonCommand command) {
		return this.ipPoolManagementWritePlatformService.updateIpAddressStatus(command);
	}
