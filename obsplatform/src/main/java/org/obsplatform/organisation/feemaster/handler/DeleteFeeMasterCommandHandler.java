...
@Service
public class DeleteFeeMasterCommandHandler implements NewCommandSourceHandler {

	private final FeeMasterWriteplatformService feeMasterWriteplatformService;

	@Autowired
	public DeleteFeeMasterCommandHandler(final FeeMasterWriteplatformService feeMasterWriteplatformService) {
	...
	public CommandProcessingResult processCommand(final JsonCommand command) {
		...
		return this.feeMasterWriteplatformService.deleteFeeMaster(command.entityId());
	}
}