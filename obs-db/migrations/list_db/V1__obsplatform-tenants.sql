CREATE DATABASE  IF NOT EXISTS `obsplatform-tenants` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `obsplatform-tenants`;
-- MySQL dump 10.13  Distrib 5.6.25, for Linux (i686)
--
-- Host: localhost    Database: obsplatform-tenants
-- ------------------------------------------------------
...
CREATE TABLE `tenant_integrations` (
  ...
  `provisioning_system` varchar(100) NOT NULL,
  `target_ip` varchar(60) NOT NULL,
  `target_url` varchar(250) NOT NULL,
  `target_port` varchar(10) NOT NULL,
  `target_username` varchar(10) NOT NULL,
  `target_password` varchar(10) NOT NULL,
  `status` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_tenantid` (`tenant_id`),
  CONSTRAINT `fk_tenantid` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`id`)
...
INSERT INTO `tenant_integrations` VALUES (1,1,'24Online','182.18.191.50','http://182.18.191.50:10080/24online/services/UserManagementService','10080','obs','obs123','Active');
...
INSERT INTO `tenants` VALUES (1,'default','Default Demo Tenant','obstenant-default','Asia/Kolkata',NULL,NULL,'NgG+HYuBQyroSZ6Ac2N0ANoE5IUrnnyihdYQBf0d8MU=','en_IN',NULL,NULL,'localhost','3306','root','mysql',1);
...
--
-- Dumping events for database 'obsplatform-tenants'
--

--
-- Dumping routines for database 'obsplatform-tenants'
--
...
-- Dump completed on 2015-08-19 14:45:49
